create or replace function get_client_cursor2(in_login in nvarchar2, in_password in nvarchar2)
...
as
  ...
  begin
    ...
    open user_cur for select CLIENTS.LOGIN,CLIENTS.PHONENUMBER, M.Model, Clients.Password from Clients
