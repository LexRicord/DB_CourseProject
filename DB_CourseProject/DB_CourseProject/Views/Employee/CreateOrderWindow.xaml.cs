        ...
        private void AddOrder_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                using (OracleConnection connection = new OracleConnection(OracleDatabaseConnection.adminConn))
                {
                    ...
                    OracleParameter emplid = new OracleParameter
                    {
                    ...
                    using (OracleCommand addOrdersCommand = new OracleCommand("addOrders", connection))
                    {
                        addOrdersCommand.CommandType = CommandType.StoredProcedure;
                        addOrdersCommand.Parameters.AddRange(new OracleParameter[] { login,  emplid, modelname, price, description });
